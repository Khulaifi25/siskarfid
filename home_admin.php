    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="content-body">
            ...
            $query_presensi_hari_ini = "SELECT COUNT(*) as total_presensi_hari_ini FROM presensi WHERE tanggal = CURDATE()";
            $result_presensi_hari_ini = mysqli_query($koneksi, $query_presensi_hari_ini);
            $data_presensi_hari_ini = mysqli_fetch_assoc($result_presensi_hari_ini);
            $total_presensi_hari_ini = $data_presensi_hari_ini['total_presensi_hari_ini'];


            // hitung jumlah tabel yang ada di tabel 'presensi'
            $query_total_presensi = "SELECT COUNT(*) as total_presensi FROM presensi";
            $result_total_presensi = mysqli_query($koneksi, $query_total_presensi);
            $data_total_presensi = mysqli_fetch_assoc($result_total_presensi);
            $total_presensi = $data_total_presensi['total_presensi'];
            ?>
                    ...
                    <div class="col-xl-3 col-xxl-3 col-sm-6">
                        <div class="card bg-warning invoice-card">
                            <div class="card-body d-flex">
                                ...
                                <div>
                                    <h2 class="text-white invoice-num"><?php echo $total_admin; ?></h2>
                    ...
                    <div class="col-xl-3 col-xxl-3 col-sm-6">
                        <div class="card bg-info invoice-card">
                            <div class="card-body d-flex">
                                ...
                                <div>
                                    <h2 class="text-white invoice-num"><?php echo $total_presensi_hari_ini; ?></h2>
                                    <span class="text-white fs-18">Presensi Hari ini</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-xxl-3 col-sm-6">
                        <div class="card bg-secondary invoice-card">
                            <div class="card-body d-flex">
                                ...
                                <div>
                                    <h2 class="text-white invoice-num"><?php echo $total_presensi; ?></h2>
                                    <span class="text-white fs-18">Total Presensi</span>
                                </div>
                            </div>
                        </div>
                    </div>
