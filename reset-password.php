                        ...
                        <div class="row no-gutters">
                            <div class="col-xl-12">
                                <div class="auth-form">
                                    ...
                                    <form action="proses_reset_pw.php" method="post">
                                        <div class="mb-3">
                                            <label><strong>UID</strong></label>
                                            <input type="text" class="form-control" name="id_card" id="id_card" placeholder="Tuliskan UID Anda" required>
                                        </div>
                                        <div class="mb-3">
                                            <label><strong>Email</strong></label>
                                            <input type="email" class="form-control" name="email" id="email" placeholder="Tuliskan Email Anda" required>
                                        </div>
