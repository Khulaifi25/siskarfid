...
if (isset($_POST['btnSubmit'])) {
    ...
    if ($simpan) {
        ...
        location.replace('edit_karyawan.php');
        </script>";
    }
}
?>
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-9">
                                            <select name="job" id="job" class="form-control">
                                                ...
                                                <option value="Supervisor" <?php if ($hasil['job'] == 'Supervisor') echo 'selected'; ?>>Supervisor</option>
                                                <option value="Manager" <?php if ($hasil['job'] == 'Manager') echo 'selected'; ?>>Manager</option>
                                                <option value="Customer Service" <?php if ($hasil['job'] == 'Customer Service') echo 'selected'; ?>>Customer Service</option>
                                                <option value="Direktur" <?php if ($hasil['job'] == 'Direktur') echo 'selected'; ?>>Direktur</option>
                                            </select>
                                        </div>
                                    </div>
                                    <fieldset class="mb-3">
