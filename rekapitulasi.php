                                ...
                                <div class="table-responsive">
                                    <table id="example4" class="display" style="min-width: 845px">
                                        <div class="d-flex justify-content-between mb-3">
                                            <a class="btn btn-dark light me-3" href="cetak.php"><i class="las la-print me-3 scale5"></i>Cetak</a>
                                        </div>
                                        <thead>
                                            <tr>
                                                <th>No</th>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    ?>
                                                    <td>
                                                        <a href="hapus_presensi.php?id=<?php echo $data['id']; ?>" class="btn btn-danger shadow btn-xs sharp" onclick="return confirm('Yakin ingin menghapus data ini?')"><i class="fa fa-trash"></i></a>
                                                    </td>
                                                </tr>
                                            <?php } ?>
                                        </tbody>
