                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="add_karyawan.php" class="m-2">
                                    <button type="button" class="btn btn-rounded btn-primary"><span class="btn-icon-start text-info"><i class="fa fa-plus color-info"></i>
                                ...
                                <div class="table-responsive">
                                    <table id="example3" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            ...
                                            //Koneksi ke DB
                                            include 'koneksi.php';
                                            //Read Data Karyawan with level 'karyawan'
                                            $sql = mysqli_query($koneksi, "SELECT * FROM karyawan WHERE level='karyawan'");
                                            $no = 0;
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            <a href="edit_karyawan.php?id=<?php echo $data['id']; ?>" class="btn btn-primary shadow btn-xs sharp me-1"><i class="fas fa-pencil-alt"></i></a>
                                                            <a href="hapus_karyawan.php?id=<?php echo $data['id']; ?>" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a>
                                                        </div>
                                                    </td>
                                                </tr>
                                            <?php } ?>
