...
<head>
    ...
    <!-- Scanning (Read) Kartu RFID -->
    <script type="text/javascript">
        $(document).ready(function() {
            setInterval(function() {
                $('#cekkartu').load('read_kartu.php')
            }, 2000);
        });
    </script>
                            ...
                            <div class="card-body">
                                ...
                                <div class="col-md-12">
                                    <div class="text-center">
                                        ...
                                        <h1 class="mt-3 font-w600">Sistem Presensi Karyawan | SISKA</h1>
                                        <p class="mt-3">Sistem Presensi Karyawan (SISKA) berbasis RFID adalah sebuah aplikasi yang dirancang untuk memudahkan proses presensi karyawan.
                                            Dengan menggunakan teknologi RFID, karyawan dapat melakukan presensi dengan cepat dan akurat hanya dengan mendekatkan kartu RFID mereka ke perangkat pembaca (Mesin Reader).
                                            Aplikasi ini membantu dalam mengelola data kehadiran karyawan secara efisien dan mengurangi kemungkinan kesalahan yang terjadi pada sistem presensi manual.</p>
                                        <br>
                                        <div class="creator-info m-0">
                                            <p>Develop by Abdurrosyid Khulaifi &emsp; | &emsp; for CV Mulia Abadi</p>
                                            <p>Contact : +62 851-5643-644</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
