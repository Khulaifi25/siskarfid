                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <a href="add_admin.php" class="m-2">
                                ...
                                <div class="table-responsive">
                                    <table id="example3" class="display" style="min-width: 845px">
                                        ...
                                        <tbody>
                                            ...
                                            $sql = mysqli_query($koneksi, "SELECT * FROM karyawan WHERE level='admin'");
                                            $no = 0;
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            <a href="edit_admin.php?id=<?php echo $data['id']; ?>" class="btn btn-primary shadow btn-xs sharp me-1"><i class="fas fa-pencil-alt"></i></a>
                                                            <a href="hapus_admin.php?id=<?php echo $data['id']; ?>" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a>
                                                        </div>
                                                    </td>
                                                </tr>
                                            <?php } ?>
