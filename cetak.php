        ...
        <div class="content-body">
            <div class="container-fluid">
                <div class="row page-titles">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item active"><a href="javascript:void(0)">Cetak</a></li>
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Rekapitulasi</a></li>
                    </ol>
                </div>
                ...
                <div class="card mb-4">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-12">
                                <form method="POST" class="form-inline d-flex justify-content-between gap-5">
                                    <input type="date" name="tgl_mulai" class="form-control">
                                    <input type="date" name="tgl_selesai" class="form-control">
                                    <button type="submit" class="btn btn-primary" name="filter-tgl">Filter</button>
                                </form>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <tbody>
                                            ...
                                            if (isset($_POST['filter-tgl'])) {
                                                ...
                                                if ($tgl_mulai == "" || $tgl_selesai == "") {
                                                    ...
                                                    $sql = mysqli_query($koneksi, "SELECT * FROM presensi ORDER BY id DESC");
                                                } else {
                                                    $sql = mysqli_query($koneksi, "SELECT * FROM presensi WHERE tanggal BETWEEN '$tgl_mulai' AND '$tgl_selesai' ORDER BY id DESC");
                                                }
                                            } else {
                                                $sql = mysqli_query($koneksi, "SELECT * FROM presensi ORDER BY id DESC");
                                            }
