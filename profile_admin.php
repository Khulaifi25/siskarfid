...
if (isset($_POST['btnSubmit'])) {
    $id_card = isset($_POST['id_card']) ? $_POST['id_card'] : $hasil['id_card'];
    ...
    if (!empty($_POST['pass_baru']) && !empty($_POST['konfirmasi_password'])) {
        ...
        if ($pass_baru != $konfirmasi_password) {
            ...
            if ($q) {
                ...
                echo "<script>document.location.href='profile_admin.php'</script>";
            } else {
                                ...
                                <div class="profile-info">
                                    ...
                                    <div class="profile-details">
                                        ...
                                        <div class="profile-email px-2 pt-2">
                                            <h4 class="text-muted mb-0"><?php echo $hasil['id_card'] ?></h4>
                                            <p>UID</p>
                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                <form method="POST" class="form-inline d-flex justify-content-between gap-3 flex-wrap">
                                                                    ...
                                                                    <a href="profile_admin.php"><button type="button" class="btn btn-danger mb-3">Reset</button></a>
                                                                </form>
                                                            </div>
                                                            <div class="mb-3 col-md-4">
                                                                <h5 class="mb-3 mt-2 font-w600">Informasi Presensi</h5>
                                                                <div class="mb-3 col-md-6">
                                                                    <?php
                                                                    if ($_SESSION['level'] == 'admin' && isset($_GET['id_card'])) {
                                                                        $id_card = $_GET['id_card'];
                                                                    } else {
                                                                        $id_card = $_SESSION['id_card']; // Karyawan hanya bisa melihat data mereka sendiri
                                                                    }
                                                                ...
                                                                <div class="mb-3 col-md-6">
                                                                    <label class="form-label">Terlambat : <?php echo $data_terlambat['total_terlambat']; ?></label>
                                                                </div>
                                                                <div class="mb-3 col-md-6">
                                                        ...
                                                        <form method="post" action="">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="mb-3 col-md-6">
                                                                    ...
                                                                    <select name="job" id="job" class="form-control default-select wide">
